...
interface EditMenuModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (menuData: MenuItem) => void;
  menuItem: MenuItem | null;
}

const EditMenuModal: React.FC<EditMenuModalProps> = ({ isOpen, onClose, onSave, menuItem }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      onSave(updatedMenu);
      showSuccess('Menu Berhasil Diperbarui', `Menu "${formData.name}" telah diperbarui`);
      handleClose();
    } catch (error) {
      showError('Gagal Menyimpan', 'Terjadi kesalahan saat memperbarui menu');
    }
  };
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="available-edit" className="ml-2 text-sm text-gray-700">
